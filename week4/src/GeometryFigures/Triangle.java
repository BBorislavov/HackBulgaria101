...
final public class Triangle implements GeometryFigure {
	...
	public String toString() {
		String result = "Triangle[(" + getLowerLeft() + ", " + getLowerRight() + ", " + getUpper() + "), ("
				+ getHeight() + ", " + getBase().getLength() + ")]";
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getLeftLine().getLength() == other.getLeftLine().getLength()
				&& getRightLine().getLength() == other.getRightLine().getLength()
